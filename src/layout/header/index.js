...
import { Layout, Menu, Avatar, Dropdown, Modal, Col, Row, Drawer } from 'antd';
				...
				<div className={style.logo}>
					...
					<Row>
						...
						<Col xs={24} sm={24} md={0} lg={0} xl={0}>
							<div
								className={style.DropdownRouter}
								onClick={() => {
									setVisible(true);
								}}
							>
				...
				<div className={style.right}>
						...
						<Col xs={0} sm={0} md={24} lg={24} xl={24}>
							<Menu onClick={handleClick} selectedKeys={[current]} mode='horizontal'>
								{getUser()
									...
									: menuArray
											.concat({ key: 'login', name: '登录' })
											.map((o) => <Menu.Item key={o.key}>{o.name}</Menu.Item>)}
							</Menu>
						</Col>
					</Row>
					<Drawer
					...
					<Dropdown overlay={DropMenu} placement='bottomCenter' trigger={['click']}>
						<div className={style.Dropdown}>
							<Avatar className={style.avatar} src='https://zos.alipayobjects.com/rmsportal/ODTLcjxAfvqbxHnVXCYX.png' />
